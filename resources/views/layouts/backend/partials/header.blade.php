            ...
            <div class="header-left">
                ...
                <div class="dropdown for-notification">
                    ...
                    <div class="dropdown-menu" aria-labelledby="notification">
                        <a class="dropdown-item media bg-flat-color-1" href="{{ url('/') }}" target="_blank">
        ...
        <div class="col-sm-5">
            <div class="user-area dropdown float-right">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="user-avatar rounded-circle" src="{{ !empty(auth()->user()->image) ? url('storage/user/'.auth()->user()->image) : url('backend/images/no_image.jpg') }}" alt="User Avatar">
                </a>
