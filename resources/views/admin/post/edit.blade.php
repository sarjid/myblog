            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Edit Post
                    ...
                    <div class="card-body card-block">
                        <form action="{{ route('post.update',$post->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="tags" placeholder="tags" class="form-control" value="@foreach ($post->tags as $key=>$tag ){{ $key+1 < count($post->tags) ? $tag->name.',' : $tag->name }} @endforeach">
                                    @error('tags')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <label for="inline-checkbox1" class="form-check-label ">
                                        <input type="checkbox" {{ $post->status == 1 ? 'checked':'' }} value="1" id="inline-checkbox1" name="status"  class="form-check-input"> Published
                                    </label>
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <img src="{{ !empty($post->image) ? url('storage/post/'.$post->image) : url('backend/images/no_image.jpg') }}" alt="" height="60px;" width="60px;">
                                </div>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Description</label></div>
                                <div class="col-12 col-md-9"><textarea name="body" id="summernote" rows="3" placeholder="Content..." class="form-control">{{ $post->body }}</textarea></div>
                                @error('body')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
